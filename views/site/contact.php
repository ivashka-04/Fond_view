...
<article id="content">
    ...
    <?php else: ?>
        ...
        <p class="mission">АО «Институт топлива,  катализа и электрохимии <br> им. Д.В. Сокольского»
            050010, г.Алматы, ул. Кунаева, 142 <br>
            РНН 600900582115<br>
            тел. 8 (727) 2916558<br>
            факс 8 (727) 2916558<br>
        </p><br>
        <p>

            Если у вас есть деловые вопросы или другие вопросы, заполните следующую форму,<br> чтобы связаться с нами.
            Спасибо.
        </p><br>
